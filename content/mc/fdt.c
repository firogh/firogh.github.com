...
static void ft_fixup_dpaa_clks(void *blob)
{
    ...
    debug("=========> Rupam %s freq fman#0 %#x fman#1 %#x qman %#x pme %#x\n", __func__,
            sysinfo.freq_fman[0], sysinfo.freq_fman[1], sysinfo.freq_qman,
            sysinfo.freq_pme);
#ifdef CONFIG_SYS_DPAA_FMAN
...
extern unsigned char fsl_fman_ucode_t1040_r1_0_106_4_14_bin[];
/**
...
printf("\nSPAG : %s, %d\n",__FUNCTION__, __LINE__);
	...
	if (!fmanfw)
		return;
#endif	
    fmanfw = fsl_fman_ucode_t1040_r1_0_106_4_14_bin;	
...
#endif
    // Rupam hardcode frequencies, gd->bus_clk, gd->arch.lbc_clk
    sysinfo.freq_processor[0] = 1500000000;
    sysinfo.freq_processor[1] = 1500000000;
    sysinfo.freq_processor[2] = 1500000000;
    sysinfo.freq_processor[3] = 1500000000;
    sysinfo.freq_systembus   = 800000000;
    sysinfo.freq_ddrbus      = 1300000000;
    sysinfo.freq_localbus    = 25000000;
    
	gd->cpu_clk = sysinfo.freq_processor[0];
	gd->bus_clk = sysinfo.freq_systembus;
	gd->mem_clk = sysinfo.freq_ddrbus;
	gd->arch.lbc_clk = sysinfo.freq_localbus;
